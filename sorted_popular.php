...
$query = "SELECT * FROM song_record ORDER BY click DESC";
...
$s_id = $row['id_no'];
echo '<tr><td>';
echo '<a href="sorted_popular.php?track='.$s_url.'"><img src="images/play.png"></a>';
echo "</td><td>";
//echo '<a href='.$s_url.'>'.$row['song_name'].'</a>';
echo '<a href="sorted_popular.php?track='.$s_url.'">'.$row['song_name'].'</a>';
echo '</td>';
