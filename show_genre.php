...
$query = "SELECT * FROM song_record WHERE genre='$a'";
...
$s_id = $row['id_no'];
echo '<tr><td>';
echo '<a href="sorted_genre.php?track='.$s_url.'"><img src="images/play.png"></a>';
echo "</td><td>";
//echo '<a href='.$s_url.'>'.$row['song_name'].'</a>';
echo '<a href="sorted_genre.php?track='.$s_url.'">'.$row['song_name'].'</a>';
echo '</td>';
